...
export const DashboardStats: React.FC<DashboardStatsProps> = ({ items, commercialDemands = [], pendencies = [], systemToday }) => {
  ...
  const stats = useMemo(() => {
    ...
    const notRetrievedCount = items.filter(i => i.status === DeliveryStatus.NOT_RETRIEVED).length;
    ...
    return {
      ...
      notRetrievedPct: total > 0 ? ((notRetrievedCount / total) * 100).toFixed(1) : '0',
      notRetrievedCount,
      // Comercial
      totalObras,
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-500 mb-8">
      ...
      <section>
        {/* Header Bar Azul */}
        {/* Header Bar Azul */}
        <div className="flex items-center gap-3 p-3 mb-4 bg-gradient-to-r from-blue-100 via-blue-50/50 to-transparent border-l-4 border-blue-500 rounded-r-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="flex flex-col h-full">
          {/* Header Bar Laranja */}
          {/* Header Bar Laranja */}
          <div className="flex items-center gap-3 p-3 mb-4 bg-gradient-to-r from-orange-100 via-orange-50/50 to-transparent border-l-4 border-orange-500 rounded-r-xl">
        ...
        <section className="flex flex-col h-full">
          {/* Header Bar Roxo */}
          {/* Header Bar Roxo */}
          <div className="flex items-center gap-3 p-3 mb-4 bg-gradient-to-r from-purple-100 via-purple-50/50 to-transparent border-l-4 border-purple-500 rounded-r-xl">
