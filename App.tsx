              ...
              {activeTab === 'deliveries' && (
                <div className="animate-in fade-in duration-300">
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                    ...
                    <div className="bg-slate-50/50 px-4 py-2 border-b border-slate-100 flex items-center justify-end">
                      <button
                        onClick={() => handleSelectAll(true)}
                        className="text-xs text-blue-600 hover:text-blue-800 font-medium flex items-center gap-1"
                      >
                        <span className="w-3 h-3 border border-blue-400 rounded-sm inline-block"></span>
                        Selecionar Todos
                      </button>
                    </div>
                    )}
                        ...
                        <thead className="bg-slate-50 border-b">
                          <tr>
                            <th className="px-4 py-3 w-8 text-center">
                              {/* Checkbox "Selecionar Todos" removido a pedido */}
                            </th>
